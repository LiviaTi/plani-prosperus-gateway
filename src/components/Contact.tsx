        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">Av. Amadeu Mazzi, 170 - Vila Rocca, Guariba - SP, 14840-000</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-md bg-primary/10 flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">(16) 99790-4725</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-md bg-primary/10 flex items-center justify-center flex-shrink-0">
          ...
          <div className="glass-card p-8 text-center">
            <div className="w-full h-64 rounded-lg overflow-hidden mb-6">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3714.567!2d-48.2311!3d-21.3553!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94b9b3e0e0e0e0e1%3A0x1234567890abcdef!2sAv.%20Amadeu%20Mazzi%2C%20170%20-%20Vila%20Rocca%2C%20Guariba%20-%20SP%2C%2014840-000!5e0!3m2!1spt-BR!2sbr!4v1700000000000"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Localização Plani Prosperus"
              />
            </div>
